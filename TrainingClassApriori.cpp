...
vector<string> TrainingClassApriori::splitStringToWords(string inputString,string delim)
{
...
void TrainingClassApriori::nPlusOnePattern(int n, int maxLengthPattern, int j,string currentPattern,int lengthOfOneWordPattern,vector<PatternUnit> oneWordPattern)
{
...
void TrainingClassApriori::training()
{  
